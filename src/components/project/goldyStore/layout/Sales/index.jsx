...
import Cards from '../../products/cards.json'
import Slider from '../Slider'
import MaterialDropDown from '../DropDown'
   ...
   return (
      <div className={style.sales} onMouseLeave={() => {setActiveCard(null)}}>
         ...
         <div className={style.btnBlock}>
            ...
            <Slider 
               winClass={activCard ? [style.sliderWin, style.sliderWinActive].join(' ') : style.sliderWin}
