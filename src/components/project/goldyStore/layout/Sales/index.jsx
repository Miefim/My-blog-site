...
const Sales = () => {
   ...
   return (
      <div className={style.sales} onMouseLeave={() => {setActiveCard(null)}}>
         ...
         <Slider 
            sliderClass={activCard ? [style.slider, style.sliderActiveCard].join(' ') : style.slider}
            btnRClass={style.buttonRightSlider}
            btnLClass={style.buttonLeftSlider}
            circleGroupClass={style.sliderCircleGroup}
         >
            <div id='1' className={activCard === '1' ? [style.card, style.cardActive].join(' ') : style.card} onMouseOver={selectActiveCard}>
