            ...
            <div className={style.imgBlock}>
               ...
               <div className={style.tape}>
                  <div className={style.unit}>
                     <img className={style.unitImage} src="\images\projectImages\goldStore\productDayImgSlider/1012076.svg" alt="" />
                  </div>
               </div>
            </div>
            <div className={style.descriptionBlock}>
               <div className={style.ratingBlock}>
                  <div className={style.ratingBlock_stars}> 
                     ...
                     <svg className={style.star} width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path className={style.star} d="M8.5 1.26413L10.339 5.53451L10.4564 5.80719L10.7521 5.83461L15.3817 6.26399L11.8886 9.33262L11.6656 9.52856L11.7309 9.81819L12.7531 14.3539L8.75528 11.9801L8.5 11.8285L8.24472 11.9801L4.24687 14.3539L5.26913 9.81819L5.33441 9.52856L5.11136 9.33262L1.61828 6.264L6.24794 5.83461L6.54356 5.80719L6.66099 5.53451L8.5 1.26413Z" stroke="#E1A661"/>
                     </svg>
                  </div>
                  4,2
               </div>
               ...
               <div className={style.sizeBlock}>
                  ...
                  <div className={style.sizeLine}>
                     <button className={[style.sizeLine_unit, style.unitSelected].join(' ')}>
                        16,5
                     </button>
                     <button className={style.sizeLine_unit}>
                        17,5
                     </button>
                     <button className={style.sizeLine_unit}>
                        18,5
                     ...
                     <button disabled className={style.sizeLine_unit}>
                        19,5
                     </button>
                     <button disabled className={style.sizeLine_unit}>
                        19,5
                  ...
                  <div className={style.buttonsGroup}>
                     ...
                     <div className={style.smallButtonsGroup}>
                        ...
                        <div className={style.smallBtn}>
                           <div className={style.smallBtn_icon}>
                              <CompareBtn className={style.smallBtn_svgSort}/>
                           </div>
                           Сравнить
                        </div>
                        <div className={style.smallBtn}>
