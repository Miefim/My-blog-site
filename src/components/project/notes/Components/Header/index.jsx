...
import { MyContext } from '../../../../../pages/ProjectNotesPage'
...
const Header = ({className}) => {
   ...
   const [response, localStore, set, del] = useLocalStorage()
   ...
   return (
      <div className={[style.header, className].join(' ')}>
         ...
         <div className={style.headerRight}>
            ...
            <Search 
               disabled={type === 2 || type === 3 || localStore.length === 0} 
               placeholder='Поиск' 
               className={type === 2 || type === 3 || localStore.length === 0 ? [style.input, style.inputDisabled].join(' ') : style.input}
            />
         </div>
         <Modal
            open={modalVisible}
